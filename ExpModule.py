...
def plot_kmeans(result, c=0.8):
    ...
    for idx in range(data_n):
        ...
        # print(c, end=" ", sep=" ")
        # c = 0
        # for cor in np.arange(0.1, 1, 0.01):
        #     if mean_absolute_percentage_error(result["Kmeans"]["P"][idx]["Pred_Y"]*c, y_val.values)<mean_absolute_percentage_error(result["Kmeans"]["P"][idx]["Pred_Y"], y_val.values):
        #         c = cor
        # print(c, end=" ", sep=" ")
